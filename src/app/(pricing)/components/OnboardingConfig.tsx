...
import { useTheme } from '@/app/(pricing)/components/theme/theme';
    ...
    <div className="min-h-screen bg-gray-50 flex items-center justify-center p-4">
      <div className="max-w-md w-full bg-white rounded-lg shadow-lg p-6 space-y-6">
        ...
        <div className="flex justify-between items-center">
          <div className={`h-2 w-full rounded-full ${step >= 1 ? 'bg-primary-500' : 'bg-gray-200'}`} />
          <div className={`h-2 w-full rounded-full ${step >= 2 ? 'bg-primary-500' : 'bg-gray-200'}`} />
        </div>
          ...
          {step === 1 && (
            <div className="space-y-4">
              ...
              <button
                ...
                className="w-full bg-primary-500 text-white py-3 rounded-lg hover:bg-primary-600 disabled:bg-gray-300 disabled:cursor-not-allowed flex items-center justify-center space-x-2"
              >
                <span>Suivant</span>
            ...
            <div className="space-y-4">
              ...
              <div className="flex space-x-3">
                ...
                <button
                  ...
                  className="w-1/2 bg-primary-500 text-white py-3 rounded-lg hover:bg-primary-600 disabled:bg-gray-300 disabled:cursor-not-allowed flex items-center justify-center space-x-2"
                >
                  <span>Terminer</span>
                  <Check size={20} />
                </button>
